...
const NotificationBell = () => {
  ...
  return (
    <div className="relative">
      ...
      {open && (
        <div className="absolute right-0 top-11 z-50 w-96 overflow-hidden rounded-xl border border-slate-200 bg-white shadow-xl">
                        ...
                        {isInvitation && invitationPending && (
                          <div className="mt-3 flex gap-2">
                            ...
                            <button
                              ...
                              className="flex-1 rounded-lg bg-indigo-600 px-3 py-2 text-xs font-semibold text-white transition hover:bg-indigo-700 disabled:cursor-not-allowed disabled:opacity-50"
                            >
