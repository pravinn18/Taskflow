  ...
  return (
    <section className="mb-6 rounded-xl border border-slate-200 bg-white p-4 shadow-sm sm:p-5">
      <div className="mb-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <button
          onClick={onAddMember}
          className="w-full rounded-lg bg-indigo-600 px-3 py-2 text-sm font-semibold text-white hover:bg-indigo-700 sm:w-auto"
        >
          + Add Member
        </button>
      </div>
      ...
      {loading ? (
        ...
        <div className="space-y-2">
          {owner && (
            <div className="flex flex-col gap-3 rounded-lg border border-slate-100 bg-slate-50 px-3 py-3 sm:flex-row sm:items-center sm:justify-between">
              ...
              <span className="self-start rounded-full bg-indigo-50 px-2.5 py-1 text-xs font-medium text-indigo-700 sm:self-auto">
                Owner
              </span>
            </div>
          )}
          ...
          {members.map((member) => (
            ...
            >
              ...
              <button
                ...
                className="w-full rounded-lg px-2.5 py-1.5 text-xs font-medium text-red-600 hover:bg-red-50 sm:w-auto"
              >
                Remove
              </button>
            </div>
